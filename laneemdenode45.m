...
%Resuelve la ecuación de Lane-Emden para un índice politrópico n
%Entradas:
...
theta=y(:,1);
%Si se alcanza theta=0 antes del puntofinal, truncar la solución
zero_crossing = find(theta <= 0, 1); %esto me lo ha dicho chatgpt
if ~isempty(zero_crossing)           %esto me lo ha dicho chatgpt
