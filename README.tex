...
los métodos iterativos. Cuando ejecutas este script obtendrás 
como resultado una tabla con la solución aproximada para los 
distintos valores del índice politrópico en cada iteración.
Depende del método que se quiera probar, deberás de introducir
...
Si quieres ejecutar un método en particular, invócalo directamente. 
Por ejemplo, con el comando de Matlab:
\begin{verbatim}
>> theta = laneemdenode45(n, epsilon, puntofinal);
\end{verbatim}
donde tienes \ubcommentinline{No usar el tú!}

que consultar el comentario inicial dentro de la función 
para ver la sintaxis exacta de sus parámetros.
...
es debido a que ambas funciones están programadas para que me devuelva
...
\begin{itemize}
  ...
  \item Comparar gráficaa y analíticamente SLM y QLM entre sí.
